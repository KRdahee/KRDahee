    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
            ...
            <section class="column">
                ...
                <small>estimation from 370kb of code in 279 edited files across 86 commits</small>
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    <mask id="languages-bar">
                        <rect x="0" y="0" width="460" height="8" fill="white" rx="5"/>
                    </mask>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="0" height="8" fill="#d1d5da"/>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="431.7173034735692" height="8" fill="#3178c6"/>
                    <rect mask="url(#languages-bar)" x="431.7173034735692" y="0" width="19.216181191397812" height="8" fill="#ededed"/>
                    <rect mask="url(#languages-bar)" x="450.933484664967" y="0" width="7.882062966382356" height="8" fill="#ededed"/>
                    <rect mask="url(#languages-bar)" x="458.8155476313494" y="0" width="1.1844523686506356" height="8" fill="#ededed"/>
                </svg>
